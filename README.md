...
Última execução: **2026-08-16** — 8 lista(s) publicada(s) (8 sem nenhuma mudança), 0 falha(s).
...
Arquivo: [`lists/ads.txt`](lists/ads.txt) — 19 fonte(s) ativas, 203639 regras após deduplicação. Atualizado em **2026-08-16**.
...
Arquivo: [`lists/full.txt`](lists/full.txt) — 85 fonte(s) ativas, 3394150 regras após deduplicação. Atualizado em **2026-08-16**.
...
| Dandelion Sprout's Game Console Adblock List | Bloqueio de anúncios em consoles de videogame | https://github.com/DandelionSprout/adfilt | Dandelicence v1.4 | https://adguardteam.github.io/HostlistsRegistry/assets/filter_6.txt |
| Steven Black's List | Combinação de ads+malware mantida por Steven Black | https://github.com/StevenBlack/hosts | MIT | https://adguardteam.github.io/HostlistsRegistry/assets/filter_33.txt |
| Peter Lowe's Blocklist | Blocklist de servidores de anúncios mantida desde os anos 2000 | https://pgl.yoyo.org/adservers/ | CC BY-SA 4.0 | https://adguardteam.github.io/HostlistsRegistry/assets/filter_3.txt |
| OISD Blocklist Big | OISD Big — lista genérica agressiva (ads+tracking+malware) | https://oisd.nl/ | Uso não comercial — ver oisd.nl/pages/faq | https://adguardteam.github.io/HostlistsRegistry/assets/filter_27.txt |
...
| StevenBlack/hosts Pi-Hole | Combinação de ads+malware mantida por Steven Black | https://github.com/StevenBlack/hosts | MIT | https://raw.githubusercontent.com/StevenBlack/hosts/master/hosts |
| AWAvenue Ads Rule | AWAvenue Ads Rule — foco em apps/sites chineses | https://github.com/TG-Twilight/AWAvenue-Ads-Rule | GPLv3 | https://adguardteam.github.io/HostlistsRegistry/assets/filter_53.txt |
...
| VeleSila | Blocklist hosts geral | https://github.com/VeleSila/yhosts | - | https://raw.githubusercontent.com/VeleSila/yhosts/master/hosts |
| Adaway original | Blocklist padrão distribuída com o AdAway | https://adaway.org/ | CC BY 3.0 | https://adaway.org/hosts.txt |
| MobileFilter | Regras específicas para apps mobile | https://github.com/AdguardTeam/AdguardFilters | GPLv3 | https://raw.githubusercontent.com/AdguardTeam/AdguardFilters/master/MobileFilter/sections/specific_app.txt |
| someonewhocares.org | Lista hosts de Dan Pollock | https://someonewhocares.org/hosts/ | Uso pessoal livre | https://someonewhocares.org/hosts/zero/hosts |
| Adblock Plus (Anti-Adblock) | Filtros contra avisos de 'desative seu adblock' | https://easylist.to/ | GPLv3 | https://easylist-downloads.adblockplus.org/antiadblockfilters.txt |
...
| Steven Black (data) | Combinação de ads+malware mantida por Steven Black | https://github.com/StevenBlack/hosts | MIT | https://raw.githubusercontent.com/StevenBlack/hosts/refs/heads/master/data/StevenBlack/hosts |
| ph00lt0 - Blocklist | Blocklist geral mantida pela comunidade | https://github.com/ph00lt0/blocklist | - | https://raw.githubusercontent.com/ph00lt0/blocklist/master/blocklist.txt |
| HaGeZi's Pop-Up Ads DNS Blocklist | HaGeZi Pop-Up Ads DNS Blocklist | https://github.com/hagezi/dns-blocklists | MIT | https://raw.githubusercontent.com/hagezi/dns-blocklists/refs/heads/main/adblock/popupads.txt |
| uBlockOrigin filters.txt | Filtros gerais do uBlock Origin | https://github.com/uBlockOrigin/uAssets | GPLv3 | https://raw.githubusercontent.com/uBlockOrigin/uAssets/refs/heads/master/filters/filters.txt |
...
| Adblock Plus (Exceptions/Allowlist) | Lista de exceções/allowlist padrão do Adblock Plus | https://easylist.to/ | GPLv3 | https://easylist-downloads.adblockplus.org/exceptionrules.txt |

## lite

Arquivo: [`lists/lite.txt`](lists/lite.txt) — 6 fonte(s) ativas, 314652 regras após deduplicação. Atualizado em **2026-08-16**.
...
Arquivo: [`lists/malware.txt`](lists/malware.txt) — 17 fonte(s) ativas, 2138604 regras após deduplicação. Atualizado em **2026-08-16**.
...
Arquivo: [`lists/phishing.txt`](lists/phishing.txt) — 9 fonte(s) ativas, 293672 regras após deduplicação. Atualizado em **2026-08-16**.
...
Arquivo: [`lists/privacy.txt`](lists/privacy.txt) — 8 fonte(s) ativas, 448191 regras após deduplicação. Atualizado em **2026-08-16**.
...
Arquivo: [`lists/social.txt`](lists/social.txt) — 2 fonte(s) ativas, 457 regras após deduplicação. Atualizado em **2026-08-16**.
...
Arquivo: [`lists/trackers.txt`](lists/trackers.txt) — 7 fonte(s) ativas, 263096 regras após deduplicação. Atualizado em **2026-08-16**.
