...
Última execução: **2026-07-05** — 8 lista(s) publicada(s) (4 sem nenhuma mudança), 0 falha(s).
...
Arquivo: [`lists/ads.txt`](lists/ads.txt) — 19 fonte(s) ativas, 204555 regras após deduplicação. Atualizado em **2026-07-05**.
...
Arquivo: [`lists/full.txt`](lists/full.txt) — 85 fonte(s) ativas, 2510429 regras após deduplicação. Atualizado em **2026-07-05**.
...
Arquivo: [`lists/malware.txt`](lists/malware.txt) — 17 fonte(s) ativas, 1747169 regras após deduplicação. Atualizado em **2026-07-05**.
