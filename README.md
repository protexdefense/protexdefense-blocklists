...
Última execução: **2026-07-05** — 8 lista(s) publicada(s), 0 falha(s).
...
Arquivo: [`lists/ads.txt`](lists/ads.txt) — 19 fonte(s) ativas, 204470 regras após deduplicação. Atualizado em **2026-07-05**.
...
Arquivo: [`lists/full.txt`](lists/full.txt) — 85 fonte(s) ativas, 2513458 regras após deduplicação. Atualizado em **2026-07-05**.
